...
function mostrarItensCarrinho() {
    ...
    carrinho.forEach((produto, indice) => {
        ...
        itemCarrinho.innerHTML = `
            <img class="carrinho-item__img" src="img/${produto.nome}.jpg" alt="${produto.nome}">
            <div class="carrinho-item-detalhes">
                <h3 class="carrinho-item-detalhes__titulo">${produto.nome}</h3>
                <p class="carrinho-item-detalhes__preco">${produto.preco.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</p>
            </div>
            <button class="carrinho-item-detalhes__button" onclick="removerItemCarrinho(${indice})">Remover</button>
        `;
